...
function isquarry() -- Function for install main server quarry.
    ...
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/FilePutContents.lua" "/lib/FilePutContents.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/GetFileContents.lua" "/lib/GetFileContents.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/UI.lua" "/lib/UI.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/split.lua" "/lib/split.lua"')
    os.sleep(1)
    fs.makeDirectory("/lib/UI")
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/UI/ButtonElement.lua" "/lib/UI/ButtonElement.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/UI/CellMap.lua" "/lib/UI/CellMap.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/UI/ElementCollection.lua" "/lib/UI/ElementCollection.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/UI/LabelElement.lua" "/lib/UI/LabelElement.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/UI/TableElement.lua" "/lib/UI/TableElement.lua"')
    shell.execute('wget "https://raw.githubusercontent.com/MajestadESP/oc_quarry/main/lib/UI/TextInputElement.lua" "/lib/UI/TextInputElement.lua"')
    os.sleep(5)
